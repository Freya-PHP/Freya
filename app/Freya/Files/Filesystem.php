...
class Filesystem {
	 ...
	 * @return array
	 */
	public function items($directory, $filetype = null)
	{
		$glob = glob($directory.'/*');
		...
		return array_filter($glob, function($file) use ($filetype)
		{
		    if ($filetype === null) {
    		    return true;
		    }
	...
	{
    	/* Placeholder for recursive file searching */
	}
